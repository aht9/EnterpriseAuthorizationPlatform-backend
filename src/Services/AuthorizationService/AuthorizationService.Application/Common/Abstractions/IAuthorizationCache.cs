...
{
    Task<IReadOnlyCollection<string>?> GetEffectivePermissionsAsync(Guid tenantId, Guid subjectId, CancellationToken cancellationToken);
    Task SetEffectivePermissionsAsync(Guid tenantId, Guid subjectId, IReadOnlyCollection<string> permissions, CancellationToken cancellationToken);
    ...
    Task InvalidateSubjectAsync(Guid tenantId, Guid subjectId, CancellationToken cancellationToken);
